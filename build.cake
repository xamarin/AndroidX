...
var NUGET_VERSION = "27.1.1.1" + NUGET_PRE;
var COMPONENT_VERSION = "27.1.1.1";
var AAR_VERSION = "27.1.1";

// API info to make diff against (previous version)
string API_INFO = "27.0.2";
string API_INFO_URL = string.Format("https://github.com/xamarin/AndroidSupportComponents/releases/download/{0}/api-info.xml", API_INFO);
...
var ARCH_CORE_COMMON_NUGET_VERSION = "1.1.1.1" + NUGET_PRE;
var ARCH_CORE_RUNTIME_NUGET_VERSION = "1.1.1.1" + NUGET_PRE;
var ARCH_LIFECYCLE_COMMON_NUGET_VERSION = "1.1.1.1" + NUGET_PRE;
var ARCH_LIFECYCLE_RUNTIME_NUGET_VERSION = "1.1.1.1" + NUGET_PRE;
var ARCH_LIFECYCLE_EXTENSIONS_NUGET_VERSION = "1.1.1.1" + NUGET_PRE;

var DOC_VERSION = "2018-04-23";
...
var ARTIFACTS = new [] {
	new ArtifactInfo (ARCH_CORE_PKG_NAME, "common", "Xamarin.Android.Arch.Core.Common", ARCH_CORE_COMMON_AAR_VERSION, ARCH_CORE_COMMON_NUGET_VERSION, "1.1.1.0", true) { PathPrefix = "arch-core/" },
	new ArtifactInfo (ARCH_CORE_PKG_NAME, "runtime", "Xamarin.Android.Arch.Core.Runtime", ARCH_CORE_RUNTIME_AAR_VERSION, ARCH_CORE_RUNTIME_NUGET_VERSION, "1.1.1.0") { PathPrefix = "arch-core/" },
	new ArtifactInfo (ARCH_LIFECYCLE_PKG_NAME, "common", "Xamarin.Android.Arch.Lifecycle.Common", ARCH_LIFECYCLE_COMMON_AAR_VERSION, ARCH_LIFECYCLE_COMMON_NUGET_VERSION, "1.1.1.0", true) { PathPrefix = "arch-lifecycle/" },
