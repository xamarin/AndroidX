...
namespace AndroidX.Slice.Widget
{
    public partial class LargeSliceAdapter
    {
        ...
        //public void OnBindViewHolder(global::AndroidX.RecyclerView.Widget.RecyclerView.ViewHolder holder, int position)
        //{
        ...
        {
            return  this.OnCreateViewHolder((global::Android.Views.ViewGroup)holder, position);
        }
    }
}
