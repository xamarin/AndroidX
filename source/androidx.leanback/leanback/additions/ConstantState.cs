...
//namespace AndroidX.Leanback.Animation {
//
//    // Metadata.xml XPath class reference: path="/api/package[@name='AndroidX.Leanback.leanback.animation']/class[@name='UntargetableAnimatorSet']"
...
////            // Metadata.xml XPath method reference: path="/api/package[@name='AndroidX.Leanback.leanback.animation']/class[@name='UntargetableAnimatorSet']/method[@name='getStartDelay' and count(parameter)=0]"
...
////                }
////            }
////            // Metadata.xml XPath method reference: path="/api/package[@name='AndroidX.Leanback.leanback.animation']/class[@name='UntargetableAnimatorSet']/method[@name='setStartDelay' and count(parameter)=1 and parameter[1][@type='long']]"
